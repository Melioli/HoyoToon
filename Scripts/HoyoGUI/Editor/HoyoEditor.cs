...
namespace Hoyo
{
    public class ShaderEditor : ShaderGUI
    {
        ...
        private void GUITopBar()
        {
            ...
            if (GuiHelper.ButtonWithCursor(Styles.icon_style_thryIcon, "Meliodas", 25, 25))
        ...
        [MenuItem("HoyoGUI/Twitter", priority = -100)]
        ...
        [MenuItem("Assets/HoyoGUI/Materials/Cleaner/List Unbound Properties", priority = 303)]
        ...
        [MenuItem("Assets/HoyoGUI/Materials/Cleaner/Remove Unbound Textures", priority = 303)]
