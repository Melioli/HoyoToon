...
namespace HoyoToon
{
    ...
    public class URL
    {
        public const string SETTINGS_MESSAGE_URL = "https://hoyotoon.com/streamedassets/hoyotoonuisettingswindow.json";
    }
    ...
    public class RESOURCE_GUID
    {
        ...
        public const string ICON_LINK = "9a9e09d5ca9ab2e4a97993756f44a7d4";
        public const string ICON_HOYOTOON = "2e2c38fd8706a444184800e2fe8a45e8";
    }
    ...
    public class TextureData
    {
        ...
        private static TextureData ParseForHoyoToonParser(string s)
        {
    ...
    public class PropertyValueAction
    {
        ...
        private static PropertyValueAction ParseForHoyoToonParser(string s)
        {
            return Parse(s);
        }
        ...
        private static PropertyValueAction[] ParseToArrayForHoyoToonParser(string s)
        {
    ...
    public class DefineableCondition
    {
        ...
        private static DefineableCondition ParseForHoyoToonParser(string s)
        {
            return Parse(s);
        }
        ...
        static DefineableCondition ParseSingle(string s, Material useThisMaterialInsteadOfOpenEditor = null)
        {
            ...
            if (s.IndexOfAny(ComparissionLiteralsToCheckFor) != -1)
            {
                ...
                else if (s.StartsWith("HoyoToonEditor", StringComparison.Ordinal))
                {
                    con.type = DefineableConditionType.EDITOR_VERSION;
                    con.data = s.Replace("HoyoToonEditor", "");
                }
