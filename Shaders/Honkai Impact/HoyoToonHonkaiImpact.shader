Shader "HoyoToon/Honkai Impact/Character Part 1"
{
    ...
    { 
        ...
        [HideInInspector] m_start_main ("Main", Float) = 0
            ...
            // Main Alpha
            [HideInInspector] m_start_mainalpha ("Alpha Options--{reference_property:_alphatoggler}", Float) = 0
        ...
        //ifex _EnableShadow == 0
            [HideInInspector] m_start_lighting("Shadows--{reference_property:_EnableShadow}", Float) = 0
        ...
        //ifex _RimGlow == 0
            //Rimlights
            [HideInInspector] m_start_rimlight("Rim Light--{reference_property:_RimGlow}", Float) = 0
        ...
        //ifex _EnableStencil == 0
            [HideInInspector] m_start_stencil("Stencil--{reference_property:_EnableStencil}", Float) = 0
        ...
        //ifex _LengthWaysDis == 0 
            [HideInInspector] m_start_dissolve("Dissolve--{reference_property:_LengthWaysDis}", Float) = 0
