...
namespace HoyoToon
{
    public class ShaderTextureProperty : ShaderProperty
    {
        ...
        public ShaderTextureProperty(ShaderEditor shaderEditor, MaterialProperty materialProperty, string displayName, int xOffset, string optionsRaw, bool hasScaleOffset, bool forceHoyoToonUI, int property_index) : base(shaderEditor, materialProperty, displayName, xOffset, optionsRaw, false, property_index)
        {
            _doCustomDrawLogic = forceHoyoToonUI;
